...
describe('game-of-life-chamix', function () {
	...
	it('calculateNextGen should calculate the next generation', function () {
		...
		var resultAssert = gameOfLife.printBoard();
		var exptected = [[0, 1, 1, 0],[0, 0, 1, 1],[0, 0, 1, 0],[0, 1, 1, 1]];
		console.log(result.length());
		assert.strictEqual(result[1][1], 0);
		assert.strictEqual(result[1][2], 1);
		assert.strictEqual(result[1][3], 1);
		assert.strictEqual(result[1][4], 0);
		assert.strictEqual(result[2][1], 0);
		assert.strictEqual(result[2][2], 0);
		assert.strictEqual(result[2][3], 1);
		assert.strictEqual(result[2][4], 1);
		assert.strictEqual(result[3][1], 0);
		assert.strictEqual(result[3][2], 0);
		//assert.strictEqual(result[3][3], 1);
		assert.strictEqual(result[3][4], 0);
